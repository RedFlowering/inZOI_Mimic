...
USpringArmComponentBase::USpringArmComponentBase(const FObjectInitializer& ObjectInitializer)
	: Super(ObjectInitializer)
{
	TargetArmLagMaxTimeStep = 1.f / 60.f;
}

void USpringArmComponentBase::OnRegister()
{
...
void USpringArmComponentBase::UpdateDesiredArmLocation(bool bDoTrace, bool bDoLocationLag, bool bDoRotationLag, float DeltaTime)
{
